...
async def main():
    ...
    agent = Agent(
        ...
        description="You are an expert research analyst with access to a comprehensive knowledge base about company contracts and partnerships.",
        instruction="You are an expert research analyst with access to a comprehensive knowledge base about company contracts and partnerships.",
    ...
    print("\n=== SEARCHING CONTRACTS ===")
    # Create a new runner to simulate a fresh session/agent but with same tools (and thus same data access via session_id)
    fresh_runner = InMemoryRunner(agent=agent)

    search_query = "I need to research our contract portfolio. Can you search for any contracts we have with companies in the insurance industry?"
